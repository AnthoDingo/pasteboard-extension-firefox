...
var past_panel = require("sdk/panel").Panel({
  ...
  contentScriptFile: ["./scripts/jquery-1.11.2.min.js", "./scripts/popup.js", "./scripts/html2canvas.js"],
	onHide: handleHide
});
...
function captureImage(error){
  var script = "html2canvas(document.body,{onrendered:function(e){self.postMessage(e)}});";
  tabs.activeTab.attach({
    contentScriptFile: ["./scripts/jquery-1.11.2.min.js" ,"./scripts/html2canvas.js", "./scripts/screenshot.js"],
...
past_panel.port.on("insertImage", function(imageData, errorMessage){
  insertImage(imageData, errorMessage);
});
